    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{mockManagerData.stats.totalProperties}</div>
            <p className="text-xs text-muted-foreground">
              {mockManagerData.stats.occupancyRate}% occupied
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{mockManagerData.stats.totalTenants}</div>
            <p className="text-xs text-muted-foreground">
              +2 from last month
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">${mockManagerData.stats.monthlyRevenue.toLocaleString()}</div>
            <p className="text-xs text-muted-foreground">
              +12% from last month
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{mockManagerData.stats.pendingMaintenance}</div>
            <p className="text-xs text-muted-foreground">
          ...
          <Card className="hover:shadow-md transition-shadow cursor-pointer">
            <CardContent className="flex items-center p-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">{mockManagerData.stats.pendingMaintenance} pending</p>
              </div>
            </CardContent>
          </Card>
        </Link>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                {mockManagerData.urgentItems.map((item) => (
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                {mockManagerData.recentActivity.map((activity) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold text-green-600">
                  {mockManagerData.stats.occupancyRate}%
                </div>
                <p className="text-sm text-gray-500 mt-2">
                  {mockManagerData.stats.totalTenants} of {Math.round(mockManagerData.stats.totalTenants / (mockManagerData.stats.occupancyRate / 100))} units occupied
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-sm text-gray-500 mt-2">
                  {mockManagerData.stats.overduePayments} overdue payments
                </p>
              </CardContent>
            </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {mockManagerData.properties.map((property) => (
