    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative w-full bg-gradient-to-r from-gray-900 to-gray-800 py-20 md:py-32">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-xl text-gray-300">
            PropertyMatch helps you find the ideal rental home with professional property management services.
          </p>
      ...
      <section className="py-16 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 dark:text-white">How PropertyMatch Works</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg mb-6 dark:text-gray-300">
                Let PropertyMatch handle the day-to-day management of your rental property. We provide comprehensive
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-white dark:bg-gray-900">
              ...
              <CardContent>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  "PropertyMatch made finding my new apartment so easy. Their team was responsive and helped me find
            ...
            <Card className="bg-white dark:bg-gray-900">
              ...
              <CardContent>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  "Since hiring PropertyMatch to manage my rental properties, I've had zero stress. They handle
            ...
            <Card className="bg-white dark:bg-gray-900">
              ...
              <CardContent>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  "The maintenance service through PropertyMatch is outstanding. Any issue I've had has been resolved
