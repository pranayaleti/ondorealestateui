...
import { Bell, Shield, AlertTriangle, Users, Globe, CheckCircle2, X } from "lucide-react"
import { useToast } from "@/hooks/use-toast"
import { formatDistanceToNow } from "date-fns"

interface Notification {
  id: string
  type: "system" | "security" | "admin" | "report"
  title: string
  message: string
  timestamp: Date
  read: boolean
...
const mockNotifications: Notification[] = [
  ...
  },
  {
    ...
    message: "New admin user created by system",
  ...
  },
  {
    ...
    message: "System performance report for last month is ready",
...
export default function SuperAdminNotifications() {
  ...
  const [activeTab, setActiveTab] = useState<"all" | "unread" | "system" | "security" | "admin">("all")
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">System-wide alerts and updates</p>
          </div>
        </div>
        {unreadCount > 0 && (
