    ...
    <footer className="w-full py-6 bg-gray-900 text-white">
      <div className="container px-4 md:px-6 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">PropertyMatch</h3>
          ...
          <div>
            ...
            <address className="not-italic text-gray-400">
              ...
              <br />
              <Link to="tel:+15551234567" className="hover:text-white">
                (555) 123-4567
              </Link>
              <br />
              <Link to="mailto:info@propertymatch.com" className="hover:text-white">
