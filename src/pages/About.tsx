        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <p className="text-lg mb-8 dark:text-gray-300">
              PropertyMatch is a professional property management company dedicated to connecting quality rental
            ...
            <p className="mb-8 dark:text-gray-300">
              ...
              exceptional service. From our property managers to our maintenance staff, everyone at PropertyMatch is
            ...
            <p className="mb-8 dark:text-gray-300">
              PropertyMatch currently serves the greater Salt Lake City area, including Salt Lake City, Holladay,
